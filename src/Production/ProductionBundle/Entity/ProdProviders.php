...
class ProdProviders {
    ...
    public function getModelsData() {
        $ma_code = $arr_list = array();
        foreach ($this->backModel as $k => $model) {
            $ma_code[$k]['id'] = $model->getId();
            $ma_code[$k]['code'] = $model->getCode();
            $ma_code[$k]['master_size'] = $model->getMasterSize();
            $ma_code[$k]['size'] = $model->getSizeMaster();

            $arr_list[$model->getId()]['id'] = $model->getId();
            $arr_list[$model->getId()]['code'] = $model->getCode();
            $arr_list[$model->getId()]['master_size'] = $model->getMasterSize();
            $arr_list[$model->getId()]['talla_master'] = $model->getMasterSize();
            $arr_list[$model->getId()]['referencia'] = $model->getCode();
            $arr_list[$model->getId()]['tallas'] = $model->getSizeMaster();
        }
        return $arr_list;
//        echo '<td class="tallpricedetall" >';
    }
